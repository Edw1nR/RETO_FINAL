...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void recibeDatos(int idEmp, String nombre, String apellido, String Documento, String Correo, String Sucursal){
    ...
    String queryIdEmpleado = "SELECT idEmp From 'empleados' WHERE documento = '"+Documento+"';";
    ...
    if(nombre.isEmpty()){
        ...
        st.executeQuery(queryIdEmpleado);
        while(rs.next()){
    ...
    //int idEmp = Integer.parseInt(txtSucursal.getText());\\
     ...
     try{
        ...
        int idEmpleado = rs.getInt("idEmp");
        String queryEliminar = "DELETE FROM 'empleados' WHERE idEmp = '"+idEmpleado+"';";
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(txtSucursal, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    void recibeDatos(String nombreEmp, String apellido, String Documento, String Correo, String Sucursal) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    void recibeDatos(String nombreEmp, String apellido, String TipoDeDocumento, String Correo, int idSucursal) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
